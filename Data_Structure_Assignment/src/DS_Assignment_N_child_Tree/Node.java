...
/**
 * @param tag provides the name, type, and description of a function parameter.
 * A node of any type. A node contains a data and links to it's children and it's parent.
 *  <T> The class type of the node
 */
public class Node<T> {
    private T data;
     ...
     * return true if the given node was a child of this node and was deleted,
     * false otherwise.
     */
